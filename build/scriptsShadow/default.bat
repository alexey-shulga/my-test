...
set CLASSPATH=%APP_HOME%\lib\default-0.1-all.jar

@rem Execute default
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DEFAULT_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%DEFAULT_EXIT_CONSOLE%" exit 1
exit /b 1
